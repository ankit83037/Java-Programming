	...
	public static void main(String[] args) {
		...
		do {
			...
			case 2:
				...
				Stream<Participant> st = viewObj.viewAllParticipants(departmentName,collegeName);
				st.forEach(p->System.out.println(p.getParticipantName()+" "+p.getDepartmentName()+" "+p.getCollegeName()));
